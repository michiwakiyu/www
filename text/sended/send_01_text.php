...
//tsushinkoza@direct-comm.com


$content = "
通信教材申し込みのお問い合わせがあります。\n\n
\n".
"お名前：".$namae."\n".
"ふりがな：".$furigana."\n".
"電話番号：".$phone."\n".
...
"mail:tsushinkoza@direct-comm.com\n".
"--------------------------------------------------------";


$mailfrom= "From: direct-commu.com<tsushinkoza@direct-comm.com>";
$subject = "通信教材申し込みのお問い合わせがあります";
...
<meta name="author" content="株式会社ダイレクトコミュニケーション" /><title>通信教材申し込み完了</title>
