...
<title>通信教材お申し込みメールを送信しました</title>
...
<div id="keyvisual">
<h1><img src="../../sp_common/images/text/img_keyvisual_text.jpg" alt="ダイレクトコミュニケーションバナー" /></h1>
</div><!-- end keyvisual -->
...
<li id="text"><a href="http://www.direct-commu.com/text/" class="selected"><span>ダイコミュ</span>通信講座</a></li>
...
<br class="brclear" />
<div id="topicpath"><a href="http://www.direct-commu.com/">トップ</a> > <a href="http://www.direct-commu.com/course/">コミュニケーション講座</a> ><span class="title_01">通信教材お申し込みメールを送信しました</span></div>

<section>
<h2 class="arrow01">
  <div><span class="title_01">通信教材お申し込みメールを送信しました</span></div>
</h2>
<div class="text">
  <p><span class="title_01">通信教材お申し込みメールを送信しました</span>！</p>
</div>
</section>

<section>
<h2 class="arrow01">
  <div><span class="title">Yahooメール,hotmailをご利用の方へ</span></div></h2>
<div class="text">
<p>弊社のメールが迷惑フォルダーに送信されやすくなっております。<br />
確実に返信メールを受け取りたい方は、予め下記アドレスをアドレス帖にご登録頂くことを<br />
お勧めします。<br />
<img src="../../sp_common/images/img_address.gif" alt="" width="230" height="28" /></p>
</div>
</section>

<section>
<h2 class="arrow01">
  <div><span class="title">迷惑フォルダに送信された場合</span></div></h2>
<div class="text">
...
<section>
<h2 class="arrow01">
  <div><span class="title_01"><span class="title">送信後2日経っても返信メールが無い場合</span></span></div></h2>
<div class="text">
