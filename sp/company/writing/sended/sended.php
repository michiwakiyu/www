...
<head>
<meta charset="UTF-8" />
<meta name="description" content="コミュニケーション能力で悩んでいませんか？改善スキルやトレーニング向上なら当サイトにお任せ♪講座のご案内もあります。明日から使えるスキルをたくさんお伝えします">
<meta name="keywords" content="コミュニケーション能力,スキル,トレーニング,向上,講座">

<title>執筆依頼メールを送信しました</title>
...
<div id="keyvisual">
<h1><img src="../../../sp_common/images/company/img_keyvisual_writing.gif" alt="執筆依頼について" /></h1>
</div><!-- end keyvisual -->
...
<li id="contact"><a href="http://www.direct-commu.com/company/contact.html" class="btn_right btn_bottom selected">お問い合わせ</a></li>
</ul>

<br class="brclear" />
<div id="topicpath"><a href="http://www.direct-commu.com/">トップ</a> > <a href="http://www.direct-commu.com/company/">会社概要</a> > <a href="http://www.direct-commu.com/company/writing/">コミュニケーション能力に関する執筆依頼</a> > <span>執筆依頼メールを送信しました</span></div>


<section>
<h2 class="arrow01"><div>執筆依頼メールを送信しました</div></h2>
<div class="text">
  <p>執筆依頼メールを送信しました！</p>
</div>
</section>
...
<section>
<h2 class="arrow01">
<div>Yahooメール,hotmailをご利用の方へ</div></h2>
<div class="text">
<p>弊社のメールが迷惑フォルダーに送信されやすくなっております。<br />
  確実に返信メールを受け取りたい方は、予め下記アドレスをアドレス帖にご登録頂くことを<br />
  お勧めします。</p>
<p><img src="../../../sp_common/images/img_address.gif" alt="" width="230" height="28" /></p>
</div>
</section>

<section>
<h2 class="arrow01">
<div>迷惑フォルダに送信された場合</div></h2>
<div class="text">
...
<section>
<h2 class="arrow01">
<div>送信後2日経っても返信メールが無い場合</div></h2>
<div class="text">
