...
if(isset($_SESSION["c_id"])){
	...
	$sql_update = "update colums set access=access+1 where url='http://www.direct-commu.com/colums/mental/".$c_id.".html'";
...
<?php 
require_once('../lib/illust.php');
echo "<p style=\"text-align: center\"><img src=\"".$path.illust($theme)."\" width=\"120\" /></p>";
?>
<!--<?=$list_same?>-->
...
<div class="wrap">
<?=$c_contents?>
<?php require_once('../lib/footer_relation.php'); ?>
