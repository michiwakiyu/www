...
$sql = "select * from bthreads where id='".$id."' and flag='1'";
$result = mysql_query($sql) or die("e");
$rows = mysql_fetch_array($result);


//コメントのスレッドidはスレッドのidとなる
$t_id = $rows["id"];
...
$sql_comment = "select * from bcomments where t_id='".$t_id."' and flag='1' order by id asc";
$result_comment = mysql_query($sql_comment) or die("e");

$html_comment = "";

while($rows_comment = mysql_fetch_array($result_comment)){
	
	$html_comment .= 
	
	"<div style=\"width: 600px; margin: auto\">".
	"<strong>".$rows_comment["target"]."</strong>さんへのコメント<br /><br />".
	$rows_comment["comment"].
	"<p style=\"text-align: right\">by ".$rows_comment["namae"]."</p>".
	"<hr class=\"line02\"></div>";
}
...
<script type="text/javascript" src="./js/validate/myvalidate_01.js"></script>
<script type="text/javascript" src="./js/fix/movie.js"></script>
...
<div id="session">
<ul class="headerlink">
<li class="link_01"><a href="logout.php">ログアウト</a></li><li class="link_02"><a href="#"></a></li>
</ul>
</div><!-- end session -->
...
<div id="topicleft"><a href="http://www.direct-commu.com/">ホーム</a> > <a href="http://www.direct-commu.com/">コミュニケーション講座</a> > <a href="http://www.direct-commu.com/course/mv/page.php?login=1">動画でスピーチを学ぶ</a> > <h1><?=$rows["title"]?></h1>
</div><!-- end topicleft -->
<div id="topicright">
...
<div class="main">
<div class="imgcenter"><img src="images/img_title_speach.gif" /></div>
 
<p class="title_01"><?=$rows["title"]?></p>

<div class="wrap">
<div class="imgcenter"><?=$rows["movie"]?></div>

<div id="comment"><?=$rows["comment"]?></div>
<hr class="line02" />
...
<div class="form">
<form action="./comment.php?t_id=<?=$t_id?>" method="post">
誰に対して？(例 とも、たつ)：<br />
<input type="text" name="target" class="form_text" />
さん<br />

コメント：<br />
<textarea name="comment" class="form_textarea"></textarea><br />
あなたの名前：<br />
<input type="text" name="namae" class="form_text" /><br />

<input type="hidden" name="cr" value="1" /><input type="submit" value="コメントする" />
</form>
</div><!-- end form -->
