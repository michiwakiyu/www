...
$sql = "select * from bthreads where flag='1' order by id asc";
...
"<div class=\"wrap\">".
"<div class=\"imgcenter\">".$rows["movie"].
"<br />".
"<a href=\"single.php?id=".$rows["id"]."\">"."コメントページへ"."</a>".
"</div><br />".
$rows["comment"].
"</div><hr class=\"line02\">"
;
...
<div id="topicleft"><a href="http://www.direct-commu.com/">ホーム</a> > <a href="http://www.direct-commu.com/">コミュニケーション講座</a> > <h1>動画でスピーチを学ぶ</h1>
</div><!-- end topicleft -->
<div id="topicright">
