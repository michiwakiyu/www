...
if(!isset($_POST["date"])){
	header("Location: http://www.direct-commu.com/manager/schedule/class/edit_ginza.php");
	exit();
}
...
header("Location: http://www.direct-commu.com/manager/schedule/class/edit_ginza.php?edit=1");
exit();
