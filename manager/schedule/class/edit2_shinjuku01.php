...
if(!isset($_POST["date"])){
	header("Location: http://www.direct-commu.com/manager/schedule/class/edit_shinjuku01.php");
	exit();
}
...
header("Location: http://www.direct-commu.com/manager/schedule/class/edit_shinjuku01.php?edit=1");
exit();
