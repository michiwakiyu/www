...
if(!isset($_POST["date"])){
	header("Location: http://www.direct-commu.com/manager/schedule/class/edit_shinjuku02.php");
	exit();
}
...
header("Location: http://www.direct-commu.com/manager/schedule/class/edit_shinjuku02.php?edit=1");
exit();
