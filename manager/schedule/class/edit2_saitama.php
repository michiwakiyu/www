...
if(!isset($_POST["date"])){
	header("Location: http://www.direct-commu.com/manager/schedule/class/edit_saitama.php");
	exit();
}
...
header("Location: http://www.direct-commu.com/manager/schedule/class/edit_saitama.php?edit=1");
exit();
